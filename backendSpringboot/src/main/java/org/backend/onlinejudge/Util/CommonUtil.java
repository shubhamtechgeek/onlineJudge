...
import org.backend.onlinejudge.Entity.Authority;
...
//    }
    ...
    public static <T> boolean ensureCreatedBy(T object , User user) {
        if (object instanceof Problem) {
            return ((Problem) object).getAuthor().getUserId().equals(user.getUserId());
//                    || user.canManageAllProblem() || isSuperAdmin(user);
        }
